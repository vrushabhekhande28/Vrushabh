...
{    
	...
	// @Test(priority=1, description="login page of actitime",groups="vr")
     ...
     public void login(@Optional("admin") String usern, @Optional("manager") String pass) throws InterruptedException
      {
		 Thread.sleep(2000);
  ...
  /*
    ...
    */
	 ...
	 public Object data()
	 {
		return new Object[][] {{"admin","manager"},{"123","123"}};
